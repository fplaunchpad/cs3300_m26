...
```bash
$ python3 ../selftest/eval.py <YOUR-ROLLNO>_P3.tar.gz
```

It builds your archive the way the grader does, so a packaging mistake shows
up here instead of costing you marks. Note that assignment 4 submits as
`_P3`, one behind the assignment number.
